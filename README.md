...
## Description
Share Anything - сервис шеринга вещей. Пользователи могут размещать предметы, которые готовы сдать в аренду, брать предметы других пользователей в аренду, размещать объявления о поиске нужных им предметов, а так же откликаться на такие же объявления других пользователей. 
